...
// npx jest tests/post/create-post-with-images.spec.ts
...
describe('POST /api/posts/with-images', () => {
  ...
  it('Creating post with images should succeed', async () => {
    ...
    const result = await supertest(app.getHttpServer())
      ...
      .attach('images', __dirname + '/assets/kurma.jpg')
      .attach('images', __dirname + '/assets/kurma.jpg')
  ...
  it('Creating post with images should fail if image is invalid', async () => {
    const loginRes = await supertest(app.getHttpServer())
      .post('/api/users/login')
      .send({
        userName: 'USERTEST123',
    ...
    const result = await supertest(app.getHttpServer())
      ...
      .field('title', 'TITLE TEST')
      .field('body', 'BODY TEST')
      .attach('images', __dirname + '/assets/invalid-file.jpg')
      .attach('images', __dirname + '/assets/kurma.jpg')
      .set('Cookie', cookieAccessToken);
